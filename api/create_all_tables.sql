-- =====================================================
-- ПОЛНЫЙ SQL ДЛЯ СОЗДАНИЯ ВСЕХ ТАБЛИЦ BETSBOT
-- =====================================================
-- Этот файл создает всю структуру БД с нуля
-- Включает все таблицы и все поля
-- Используйте для создания новой БД или проверки структуры
-- =====================================================
