-- =====================================================
-- SQL ДЛЯ СОЗДАНИЯ ВСЕХ ТАБЛИЦ BETSBOT
-- =====================================================
-- Файл: dbnew.sql
-- Использование: Выполните этот файл внутри существующей базы данных
-- =====================================================
-- ВАЖНО: Убедитесь, что вы выбрали нужную БД перед выполнением:
-- USE betsbot_db;
-- =====================================================
