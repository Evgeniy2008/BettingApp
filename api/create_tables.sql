-- =====================================================
-- SQL ДЛЯ СОЗДАНИЯ ТАБЛИЦ BETSBOT
-- =====================================================
-- Этот файл создает все таблицы в существующей БД
-- БД должна быть уже создана!
-- =====================================================
-- ИСПОЛЬЗОВАНИЕ:
-- 1. Выберите вашу БД в phpMyAdmin
-- 2. Вкладка "SQL" или "Import"
