 ...
 */
export async function parseW54DetailPageFromUrl(url) {
 ...
 */
export function parseW54DetailPageHtml(html, url) {
        ...
        $groups.each((_groupIdx, groupEl) => {
            ...
            $buttons.each((_btnIdx, btnEl) => {
                ...
                if (groupTitleLower.includes("исход") || groupTitleLower.includes("1x2") ||
                    ...
                    type = "1x2";
                    if (label.match(/^П1|1$/i))
                        finalLabel = "1";
                    else if (label.match(/^X|Ничья$/i))
                        finalLabel = "X";
                    else if (label.match(/^П2|2$/i))
                        finalLabel = "2";
                }
                // Totals
